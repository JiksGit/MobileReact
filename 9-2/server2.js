...
var userList = [
    ...
    { keyid: 2, name : "양길동", id: "kdyang", passwd: "1132"},
    { keyid: 3, name : "양길은", id: "kwyang", passwd: "3232"},
    { keyid: 4, name : "양길금", id: "kkyang", passwd: "1331"}
];
...
const addUser = (req, res) => {
    ...
    console.log("회원등록 요청을 완료하였으며, 이를 반영한 전체 목록입니다");
    userList.map((user, i) => {
